...
description: >-
  Add single sentance descripting RA.
services: ''
...
editor: ''
tags: ''
pnp.series.title: add pnp title tag
...
cardTitle: RA Template cardTitle
---
# Revise Title to Run a Target RA
[!INCLUDE [header](../../_includes/header.md)]

This reference architecture shows a set of proven practices for **ADD TEXT FOR TARGET RA** on Azure. 
...
Provisioning a **ADD TARGET RA** in Azure involves more moving parts than just the VM itself. There are compute, networking, and storage elements that you need to consider.

**REVISE THE FOLLOWING LIST WITH THE AZURE ASSEST THAT USED TO BUILD OUT THE TARGET RA.**

**THE FOLLOWING IS AN EXAMPLE FOR A SINGLE WINDOWS VM**
...
**REVISE THE FOLLOWING RECOMMENDATION FOR EACH AZURE ASSET LISTED AND FOR THE CROSS CUTTING FUNCTIONALITY IN THE ABILIITY SECTIONS.**

This architecture shows the baseline recommendations for running **THE TARGET RA** in Azure. 

**EXAMPLE OF RECOMMENDATION FOR A SINGLE WINDOWS VM**


However, we don't recommend using a single VM for mission critical workloads, because it creates a single point of failure. For higher availability, deploy multiple VMs in an [availability set][availability-set]. For more information, see [Running multiple VMs on Azure][multi-vm]. 
...
**REVISE FOR TARGET RA. SHOULD BE HIGH LEVEL WITH LINKS TO DETAILED DOCUMENTS**
...
**REVISE INSTRUCTIONS TO DEPLOY THE MARKETPLACE ASSET. THE FOLLOWING EXAMPLE IS FOR DEPLOYING SINGLE WINDOW VM** 

**SPECIFIC ITEMS TO REVISE:**
    *LINK SHOULD OPEN UP THE PORTAL MARKETPLACE ASSET.*
    *ADD DESCRIPTIONS PER ENTRY TO BUILD OUT THE ARM TEMPLATE* 
...
[0]: ./images/single-vm-diagram.png "Replace Image with RA Target Diagram."
