...
[Azure
subscriptions](/azure/virtual-machines/virtual-machines-linux-infrastructure-subscription-accounts-guidelines/)
...
and
constraints](/azure/azure-subscription-service-limits/).
...
-   [How to add or change Azure administrator
    roles](/azure/billing-add-change-azure-subscription-administrator/)

-   [How to download your Azure billing invoice and daily usage
    data](/azure/billing-download-azure-invoice-daily-usage-date/)
...
Both Azure and AWS have entities called "resource groups" that organize resources such as VMs, storage, and virtual networking devices. However, [Azure resource groups](/azure/virtual-machines/virtual-machines-windows-infrastructure-resource-groups-guidelines/) are not directly comparable to AWS resource groups.
...
[tags](/azure/resource-group-using-tags/).
...
-   [Web
    interface](/azure/resource-group-portal/).
...
-   [Command
    Line](/azure/xplat-cli-azure-resource-manager/).
...
-   [Templates](/azure/resource-group-authoring-templates/).
...
-   [Azure resource group
    guidelines](/azure/virtual-machines/virtual-machines-windows-infrastructure-resource-groups-guidelines/)
...
In Azure, a [fault
domain](/azure/virtual-machines/virtual-machines-linux-manage-availability/)
defines a group of VMs that shares a physical power source and network switch.
You use [availability
sets](/azure/virtual-machines/virtual-machines-windows-manage-availability/)
...
![AWS Availability Zones compared with Azure fault domains and availability sets](./images/zone-fault-domains.png "AWS Availability Zones compared with Azure fault domains and availability sets")
...
![Availability sets for each application role](./images/three-tier-example.png "Availability sets for each application role")
...
regions](/azure/best-practices-availability-paired-regions/)
...
Azure [geo-redundant
storage](/azure/storage-redundancy/#geo-redundant-storage)
...
-   [Regions and availability for virtual machines in
    Azure](/azure/virtual-machines/virtual-machines-linux-regions-and-availability/)

-   [Disaster recovery and high availability for applications built on Microsoft
    Azure](/azure/resiliency-disaster-recovery-high-availability-azure-applications/)

-   [Planned maintenance for Linux virtual machines in
    Azure](/azure/virtual-machines/virtual-machines-linux-planned-maintenance/)
...
-   [Sizes for virtual machines in Azure
    (Windows)](/azure/virtual-machines/virtual-machines-windows-sizes/)

-   [Sizes for virtual machines in Azure
    (Linux)](/azure/virtual-machines/virtual-machines-linux-sizes/)
...
disks](/azure/virtual-machines/virtual-machines-linux-about-disks-vhds/)
...
-   [WebJobs](/azure/web-sites-create-web-jobs/) - allow you to create scheduled or continuously running background tasks.
...
-   [VM scale
    sets](/azure/virtual-machine-scale-sets-overview/) - allow you to deploy and manage an identical set of VMs. The number of
    instances can autoscale based on performance needs.

-   [App Service
    Autoscale](/azure/web-sites-scale/) - provides the capability to autoscale Azure App Service solutions.
...
-   [Azure
    Batch](/azure/batch-technical-overview/) - allows you to manage compute-intensive work across a scalable collection
    of virtual machines.

-   [Service
    Fabric](/azure/service-fabric-overview/) - platform for developing and hosting scalable
    [microservice](/azure/service-fabric-overview-microservices/)
    solutions.

#### See also

-   [Create a Linux VM on Azure using the
    Portal](/azure/virtual-machines/virtual-machines-linux-quick-create-portal/)

-   [Azure Architectural Blueprint: Running a Linux VM on
    Azure](/azure/architecture/virtual-machines-linx/single-vm/)

-   [Get started with Node.js web apps in Azure App
    Service](/azure/app-service-web-nodejs-get-started/)

-   [Azure Architectural Blueprint: Basic web
    application](/azure/architecture/app-service/web-apps-basic/)

-   [Create your first Azure
    Function](/azure/functions-create-first-azure-function/)
...
accounts](/azure/storage-create-storage-account/)
allow you to create and manage the following storage services:

-   [Blob
    storage](/azure/storage-create-storage-account/) - stores any type of text or binary data, such as a document, media file, or
...
-   [Table
    storage](/azure/storage-nodejs-how-to-use-table-storage/) - stores structured datasets. Table storage is a NoSQL key-attribute data
...
-   [Queue
    storage](/azure/storage-nodejs-how-to-use-queues/) - provides messaging for workflow processing and for communication between
    components of cloud services.

-   [File
    storage](/azure/storage-java-how-to-use-file-storage/) - offers shared storage for legacy applications using the standard server
...
tier](/azure/storage-blob-storage-tiers/).
...
-   [Microsoft Azure Storage Performance and Scalability
    Checklist](/azure/storage-performance-checklist/)

-   [Azure Storage security
    guide](/azure/storage-security-guide/)

-   [Patterns & Practices: Content Delivery Network (CDN)
    guidance](/azure/best-practices/cdn/)
...
-   [Load
    Balancer](/azure/load-balancer-overview/) - provides the same capabilities as the AWS Classic Load Balancer, allowing
    you to distribute traffic for multiple VMs at the network level. It also
    provides failover capability.

-   [Application
    Gateway](/azure/application-gateway-introduction/) - offers application-level rule-based routing comparable to the AWS
...
-   [Azure DNS](/azure/dns/) - provides domain and DNS management.

-   [Traffic
    Manager](/azure/traffic-manager-overview/) - provides DNS level traffic routing, load balancing, and failover
    capabilities.
...
connections](/azure/vpn-gateway-howto-site-to-site-resource-manager-portal/)
at a lower cost.

#### See also

-   [Create a virtual network using the Azure
    portal](/azure/virtual-network/virtual-networks-create-vnet-arm-pportal/)

-   [Plan and design Azure Virtual
    Networks](/azure/virtual-network/virtual-network-vnet-plan-design-arm/)

-   [Azure Network Security Best
    Practices](/azure/azure-security-network-security-best-practices/)
...
[SQL
Database](/azure/sql-database-technical-overview/)
...
[MySQL](/azure/virtual-machines/virtual-machines-windows-classic-mysql-2008r2/)
...
-   [Azure SQL Database
    Tutorials](/azure/sql-database-explore-tutorials/)

-   [Configure geo-replication for Azure SQL Database with the Azure
    portal](/azure/sql-database-geo-replication-portal/)

-   [Introduction to DocumentDB: A NoSQL JSON
    Database](/azure/documentdb-introduction/)

-   [How to use Azure Table storage from
    Node.js](/azure/storage-nodejs-how-to-use-table-storage/)
...
-   [Azure Active
    Directory](/azure/active-directory-whatis/) - cloud based directory and identity management service.

-   [Azure Active Directory
    B2B](/azure/active-directory-b2b-collaboration-overview/) - enables access to your corporate applications from partner-managed
    identities.

-   [Azure Active Directory
    B2C](/azure/active-directory-b2c-overview/) - service offering support for single sign-on and user management for
    consumer facing applications.

-   [Azure Active Directory Domain
    Services](/azure/active-directory-ds-overview/) - hosted domain controller service, allowing Active Directory compatible
    domain join and user management functionality.

#### Web application firewall

In addition to the [Application Gateway Web Application
Firewall](/azure/application-gateway-webapplicationfirewall-overview/),
you can also [use web application
firewalls](/azure/application-gateway-webapplicationfirewall-overview/)
...
-   [Getting started with Microsoft Azure
    security](/azure/azure-security-getting-started/)

-   [Azure Identity Management and access control security best
    practices](/azure/azure-security-identity-management-best-practices/)
...
-   [Queue
    storage](/azure/storage-nodejs-how-to-use-queues/) - a cloud messaging service that allows communication between application
...
-   [Service
    ...
    relay](/azure/service-bus-relay/relay-what-is-it),
...
-   [How to use Queue storage from
    Node.js](/azure/storage-nodejs-how-to-use-queues/)

-   [How to use Service Bus
    queues](/azure/service-bus-nodejs-how-to-use-queues/)
...
-   [Data
    Factory](/azure/data-factory/) - provides data orchestration and data pipeline functionality.

-   [SQL Data
    Warehouse](/azure/sql-data-warehouse/) - large-scale relational data storage.

-   [Data Lake
    Store](/azure/data-lake-store/) - large-scale storage optimized for big data analytics workloads.

-   [Machine
    Learning](/azure/machine-learning/) - used to build and apply predictive analytics on data.

-   [Stream
    Analytics](/azure/stream-analytics/) - real-time data analysis.

-   [Data Lake
    Analytics](/azure/data-lake-analytics-overview/) - large-scale analytics service optimized to work with Data Lake Store
...
-   [Get started with Azure IoT
    Hub](/azure/iot-hub-csharp-csharp-getstarted/)

-   [Comparison of IoT Hub and Event
    Hubs](/azure/iot-hub-compare-event-hubs/)
...
-   [Create an Android
    app](/azure/app-service-mobile-android-get-started/)

-   [Authentication and Authorization in Azure Mobile
    Apps](/azure/app-service-mobile-auth/)

-   [Sending push notifications with Azure Notification
    Hubs](/azure/notification-hubs-android-push-notification-google-fcm-get-started/)

### Management and monitoring

#### See also
-   [Monitoring and diagnostics
    guidance](/azure/architecture/best-practices/monitoring/)

-   [Best practices for creating Azure Resource Manager
    templates](/azure/resource-manager-template-best-practices/)
...
-   [Azure Reference
    Architectures](/azure/architecture/)

-   [Patterns & Practices: Azure
    Guidance](/azure/architecture/)
