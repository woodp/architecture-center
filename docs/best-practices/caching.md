...
> [What is Azure Redis Cache offering and what size should I use?](/azure/redis-cache/cache-faq.md#what-redis-cache-offering-and-size-should-i-use) on the Microsoft website.
> 
> 
