---
title: Resiliency for recovery from loss of an Azure region technical guidance
...
## Next steps
This article is part of a series focused on [Azure resiliency technical guidance](technical-guidance.md). The next article in this series focuses on [recovery from an on-premises datacenter to Azure](technical-guidance-recovery-on-premises-azure.md).
